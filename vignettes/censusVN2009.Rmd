...
vignette: >
  %\VignetteIndexEntry{Using censusVN2009}
...
provinces (63) of Vietnam after the last major administrative borders update of
2008, January 1st (essentially the merging of the provinces of Ha Tay and Ha
Noi), together with the populations sizes from the 2009 census as attributes for
each of the three levels (commune, district and province).
...
Likewise, the Spratley islands are included in the province of Khanh Hoa (Nha
Trang):
...
Quang Ninh and Hai Phong correspond to Ha Long bay, Kien Giang correpons to
Phu Quoc, Ba Ria - Vung Tau corresponds to Can Dao, Quang Nam corresponds to
Cham islands. We can trim off these islands off by extracting the largest
polygon of each of these provinces:
